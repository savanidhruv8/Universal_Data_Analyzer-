...
with col1:
    ...
    if st.button("⬅️ Back", key="excel_back_button"):
        st.switch_page("main.py")

st.title("🧹 Excel Data Cleaner & Analyzer")
...
if uploaded_file:
    ...
    try:
        ...
        st.write("✅ Excel file loaded and converted to DataFrame.")
        # Convert to CSV in-memory for potential download
...
if st.session_state.df is not None:
    ...
    dtype_conversions = {}  # Fixed typo: 'dtype conversions' to 'dtype_conversions'
    ...
    if st.button("🚀 Clean and Analyze Dataset"):
        ...
        # Download cleaned JSON (added for flexibility)
